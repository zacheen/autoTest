...
if __name__ == "__main__":
    try:
        ...
        # User interruption is not an error and should not be written to cuda_debug.log.
        raise
    except Exception:
        # Persist any unhandled exception, including CUDA errors, before CMD output is lost.
